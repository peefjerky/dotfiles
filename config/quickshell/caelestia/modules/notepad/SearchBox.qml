...
//
// Named SearchBox rather than SearchField because Qt 6.10 added
// QtQuick.Controls.SearchField, and an explicit module import beats the implicit
// same-directory one -- a file here called SearchField.qml would silently resolve
// to Qt's, which has no `hint` property.
//
